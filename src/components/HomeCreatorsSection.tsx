...
const HomeCreatorsSection = () => (
  <ContentSection 
    ...
    viewAllLink="https://www.xdose.xvush.com/trending"
    ...
    <div className="flex flex-col items-center sm:grid sm:grid-cols-2 md:grid-cols-3 gap-6">
      {creators.map((creator) => (
        <div key={creator.id} className="w-full max-w-md">
          <a href="https://www.xdose.xvush.com/trending">
      ...
      <div className="flex items-center justify-center">
        <Button 
          ...
          asChild
        >
          <a href="https://www.xdose.xvush.com/trending" className="text-center">
