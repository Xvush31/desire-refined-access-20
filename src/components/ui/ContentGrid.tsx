        ...
        {trendingContents.length > 0 && (
          <div className="mb-6">
            <h2 className="text-lg font-semibold mb-3 flex items-center">
              <Layers size={18} className="mr-2 text-brand-red" />
              Tendances
            </h2>
    ...
    const renderedCollections = collections.length > 0 ? collections : 
      ...
      Object.entries(
        contents.reduce<Record<string, Content[]>>((acc, content) => {
          const collection = content.collection || 'Non classé';
  ...
  if (layout === 'featured') {
    ...
    return (
      <div className={cn("space-y-8", className)}>
        ...
        {featured && (
          <div>
            <h2 className="text-xl font-semibold mb-3">Contenu à la une</h2>
            <ContentCard 
        ...
        {trendingFromRest.length > 0 && (
          <div>
            <h2 className="text-xl font-semibold mb-3 flex items-center">
              <Layers size={20} className="mr-2 text-brand-red" />
              Tendances
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        {/* Recent content */}
        <div>
          <h2 className="text-xl font-semibold mb-3">Contenu récent</h2>
      ...
      <div className={cn("grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4 auto-rows-max", className)}>
        {contents.map((content, index) => {
          ...
          if (index % 7 === 0 || hasHighEngagement) {
            size = 'lg';
            itemClassName = 'col-span-2 row-span-2';
          } else if (index % 5 === 0 || isTrending) {
            size = 'md';
            itemClassName = 'col-span-1 row-span-1';
          }
